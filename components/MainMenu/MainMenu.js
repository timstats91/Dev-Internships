...
export const MainMenu = ({items}) => {
    ...
    return (
        <nav className="bg-slate-800 text-white md:px-5 h-[64px] justify-between sticky top-0 z-50 flex">
            <Link href="/">
            ...
            <div className={(showNav ? "top-16" : "-top-full") + " md:flex md:flex-1 md:justify-end fixed md:static mx-auto text-center bg-slate-800 w-screen z-50"}>
